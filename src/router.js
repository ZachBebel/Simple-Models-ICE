...
var router = function (app) { //pass the express app in
    ...
    app.get('/getName', controllers.catGetName);
    app.get('/findCatByName', controllers.catSearchName);
    app.get('/findDogByName', controllers.dogSearchName);
