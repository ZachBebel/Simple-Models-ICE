...
//default fake data so that we have something to work with until we make a real Cat or Dog
var defaultData = {
    name: "unknown",
    bedsOwned: 0
};
...
var catGetName = function (req, res) {
...
var catSetName = function (req, res) {
...
//and get a pre-filled out response object to send
//ADDITIONALLY, with body-parser we will get the body/form/POST data in the request as req.body
var dogSetName = function (req, res) {
...
//controller functions in Express receive the full HTTP request 
//and a pre-filled out response object to send
var catSearchName = function (req, res) {
...
//controller functions in Express receive the full HTTP request 
//and a pre-filled out response object to send
var dogSearchName = function (req, res) {
...
var catUpdateLast = function (req, res) {
...
module.exports = {
    ...
    page2: hostPage2,
    page3: hostPage3,
    catGetName: catGetName,
    catSetName: catSetName,
    catUpdateLast: catUpdateLast,
    catSearchName: catSearchName,
    dogSetName: dogSetName,
    dogSearchName: dogSearchName,
    notFound: notFound
};